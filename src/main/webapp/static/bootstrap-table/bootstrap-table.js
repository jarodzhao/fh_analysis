...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (typeof this.options.toolbar === 'string') {
            $(sprintf('<div class="pull-%s"></div>', this.options.toolbarAlign))
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                sprintf('<input class="input-sm form-control' + (this.options.iconSize === undefined ? '' : ' input-' + this.options.iconSize) + '" type="text" placeholder="%s">',
